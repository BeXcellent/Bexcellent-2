	...
	<div class="container-fluid">
		<div class="row" style="z-index: -5">
			...
			<div class="col-md-10 col-md-offset-1">
                            <a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URL'] ?>" id="titlelink"><img class="img-responsive" id="title" src="<?php echo get_template_directory_uri(); ?>/texture/new_bubbles/background.png" alt="BeXcellent"></a>
